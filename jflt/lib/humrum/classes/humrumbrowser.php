 ...
 *
 * This implementation is based on the work from Chris Schuld
...
class HumrumBrowser {
    ...
    public function reset() {
        ...
        $this->_browser_name = BROWSER_UNKNOWN;
    ...
    protected function checkBrowserBlackBerry() {
        if (stripos($this->_agent, 'blackberry') !== false) {
            ...
            $this->_browser_name = BROWSER_BLACKBERRY;
            $this->setMobile(true);
            return true;
        }
        return false;
    ...
    protected function checkBrowserGoogleBot() {
        if (stripos($this->_agent, 'googlebot') !== false) {
            ...
            $this->_browser_name = BROWSER_GOOGLEBOT;
            $this->setRobot(true);
            return true;
        }
        return false;
    ...
    protected function checkBrowserMSNBot() {
        if (stripos($this->_agent, "msnbot") !== false) {
            ...
            $aversion = explode(" ", $aresult[1]);
            $this->setVersion(str_replace(";", "", $aversion[0]));
            $this->_browser_name = BROWSER_MSNBOT;
            $this->setRobot(true);
            return true;
        }
        return false;
    ...
    protected function checkBrowserW3CValidator() {
        if (stripos($this->_agent, 'W3C-checklink') !== false) {
            ...
            $aversion = explode(' ', $aresult[1]);
            $this->setVersion($aversion[0]);
            $this->_browser_name = BROWSER_W3CVALIDATOR;
            return true;
    ...
    protected function checkBrowserSlurp() {
        if (stripos($this->_agent, 'slurp') !== false) {
            ...
            $aversion = explode(' ', $aresult[1]);
            $this->setVersion($aversion[0]);
            $this->_browser_name = BROWSER_SLURP;
            $this->setRobot(true);
    ...
    protected function checkBrowserOpera() {
        if (stripos($this->_agent, 'opera mini') !== false) {
            ...
            $this->_browser_name = BROWSER_OPERA_MINI;
            $this->setMobile(true);
            return true;
            ...
            $this->_browser_name = BROWSER_OPERA;
            return true;
        }
        return false;
    }
    ...
    function isIE6() {
        return ($this->_browser_name == BROWSER_IE && $this->_version < 7 );
    }
