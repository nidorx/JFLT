...
/*
  « Padrões »
  <<------------------------------------------------------------------------------
  camelCaseComecandoComMinuscula    - variaveis
  CamelCaseComecandoComMaiuscula    - funções public | classes
  _camelCaseComecandoComUnderline   - funções private
