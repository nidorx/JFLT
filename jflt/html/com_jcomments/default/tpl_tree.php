...
?>
    ...
    ?>
                ...
                <ol class="comments-list" start="<?php echo $i+1; ?>" id="comments-list-<?php echo $comment->parent; ?>"><!--INICIO 02-->
    <?php
                } else {
                    $j = 0;
...
?>
                <li class="<?php echo ($i % 2 ? 'odd' : 'even'); ?>" id="comment-item-<?php echo $id; ?>">
    <?php
                echo $comment->html;
...
?>
                <li class="<?php echo ($i % 2 ? 'odd' : 'even'); ?>" id="comment-item-<?php echo $id; ?>"><?php echo $comment; ?></li>
<?php
            } else {
?>
